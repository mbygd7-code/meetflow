...
export const MILO_INTERVENTION_TRIGGERS = {
  ...
  // 요청/지시형 — AI에게 작업을 요청하는 패턴
  REQUEST: /(해줘|해주세요|해 줘|해 주세요|찾아줘|찾아주세요|알려줘|알려주세요|분석해|분석해줘|정리해|정리해줘|진행해|진행해주세요|시작해|시작해주세요|검토해|검토해줘|제안해|제안해줘|만들어|만들어줘|비교해|비교해줘|조사해|조사해줘|설명해|설명해줘|어떻게|어떤|뭐가|무엇을|왜\s)/,
};
