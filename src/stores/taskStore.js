...
const MOCK_TASKS = [
  ...
  {
    id: 't10',
    title: '회의 요약 AI 정확도 테스트',
    description: '회의 종료 후 AI 요약 품질 검증.\n결정 사항, 후속 태스크 추출 정확도 점검.',
    status: 'in_progress',
    priority: 'high',
    due_date: new Date(Date.now() + 3 * 86400 * 1000).toISOString().slice(0, 10),
    assignee_id: 'demo',
    assignee: { id: 'demo', name: 'demo', color: '#FF902F' },
    assignee_name: 'demo',
    meeting_id: 'mtg-001',
    meeting_title: '주간 프로덕트 스탠드업',
    service_name: 'MeetFlow',
  ...
  },
  {
    id: 't11',
    title: '모바일 반응형 QA',
    description: 'iPhone/Android 주요 화면 반응형 테스트.\n하단 탭, 사이드바 드로어, 회의방 레이아웃 점검.',
    status: 'todo',
    priority: 'medium',
    due_date: new Date(Date.now() + 5 * 86400 * 1000).toISOString().slice(0, 10),
    assignee_id: 'demo',
  ...
  },
  {
    id: 't12',
    title: '투표 기능 사용성 검증',
    description: '회의 중 투표 생성/참여 플로우 사용성 테스트.\n결과 시각화, 실시간 업데이트 확인.',
    status: 'in_progress',
    priority: 'urgent',
